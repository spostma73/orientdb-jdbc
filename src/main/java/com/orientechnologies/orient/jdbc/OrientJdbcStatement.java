...
public class OrientJdbcStatement implements Statement {
  ...
  public boolean execute(final String sql) throws SQLException {
    ...
    if (sql.equalsIgnoreCase("select 1")) {
      ...
      if(connection.isTranslateH2SQL())
      {
          resultSet = null;
          for(String sqlSection : H2.translate(sql))
          {
              OrientJdbcResultSet resultSet = executeSection(sqlSection);
              if(resultSet == null)
                  return false;
        ...
        resultSet = executeSection(sql);
    }
    return resultSet != null;
  }

    private OrientJdbcResultSet executeSection(String sql) throws SQLException
    {
        ...
        return new OrientJdbcResultSet(this, documents, resultSetType, resultSetConcurrency, resultSetHoldability);
    }
  ...
  public int executeUpdate(final String sql) throws SQLException {
      if(connection.isTranslateH2SQL())
      {
          ...
          for(String sqlSection : H2.translate(sql))
          {
              OrientJdbcResultSet resultSet = executeUpdateSection(sqlSection);
              if(rawResult == null)
                  return 0;
              if(this.rawResult == null)
                  this.rawResult = resultSet;
          }
      }
      else
        rawResult = resultSet = executeSection(sql);
    ...
    private OrientJdbcResultSet executeUpdateSection(String sql) throws SQLException
    {
        query = new OCommandSQL(sql);
